...
$repo=new LifecycleMemoryRepository(); $repo->fail=true; $service=new VoucherManager\Domain\Pool\PoolLifecycleService($repo,new VoucherManager\Domain\Log\OperationalLogger($logs)); try{$service->delete_pool(7,'Retired Campaign');}catch(RuntimeException){}
