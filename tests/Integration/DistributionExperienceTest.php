...
$assert( 'Pool: Summer' === $view->pool_message( 'Summer' ), 'Success result must identify the source Pool.' );
$assert( 'Remaining inventory: 1 One-Time Code' === $view->remaining_message( 1 ), 'Singular remaining inventory must use correct grammar.' );
$assert( 'Remaining inventory: 4 One-Time Codes' === $view->remaining_message( 4 ), 'Plural remaining inventory must use correct grammar.' );
$assert( 'Remaining inventory: 0 One-Time Codes' === $view->remaining_message( 0 ), 'Empty inventory must remain explicit.' );
