...
<div class="wrap voucher-manager">
	...
	<section class="voucher-manager__card"><h2><?php echo esc_html( $pool->name() ); ?></h2>
		<dl><dt><?php echo esc_html__( 'Total One-Time Codes', 'voucher-manager' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $summary['total'] ) ); ?></dd><dt><?php echo esc_html__( 'Available', 'voucher-manager' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $summary['available'] ) ); ?></dd><dt><?php echo esc_html__( 'Distributed', 'voucher-manager' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $summary['assigned'] ) ); ?></dd><dt><?php echo esc_html__( 'Imports', 'voucher-manager' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $summary['imports'] ) ); ?></dd></dl>
	</section>
	<section class="voucher-manager__card"><h2><?php echo esc_html__( 'Delete available One-Time Codes', 'voucher-manager' ); ?></h2><p><?php echo esc_html( sprintf( __( 'Permanently delete %d unused One-Time Codes. Assigned One-Time Codes, the pool and operational history are preserved.', 'voucher-manager' ), $summary['available'] ) ); ?></p>
