...
final class DashboardViewModel {
	...
	public function activity_label( string $event_type, array $context = array() ): string {
		...
		return match ( $event_type ) {
			...
			'admin.action_failed'          => __( 'Administrative action could not be completed', 'mjs-productions-voucher-manager' ),
			'settings.updated'             => __( 'Settings updated', 'mjs-productions-voucher-manager' ),
			'activity.cleanup_completed'   => __( 'Activity History cleanup completed', 'mjs-productions-voucher-manager' ),
			'activity.cleanup_failed'      => __( 'Activity History cleanup failed', 'mjs-productions-voucher-manager' ),
