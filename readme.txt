...
* Added granular Voucher Manager capabilities while preserving administrator-only standalone access.
* Made Dashboard content and internal navigation capability-aware for extension-delegated access.
* Added extension notifications for inventory changes and Pool warning-threshold changes.
* Unified Activity History detail presentation across event types.
* Added dedicated real-MySQL concurrency verification and shared localization quality infrastructure.
* Refined WordPress.org product terminology and added information about the planned Voucher Manager Pro extension.
* No database schema migration is required.
