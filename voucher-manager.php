...
define( 'VOUCHER_MANAGER_VERSION', '0.1.0-alpha' );
...
if ( ! is_readable( $voucher_manager_autoloader ) ) {
	add_action( 'admin_notices', static function (): void {
		...
		printf( '<div class="notice notice-error"><p>%s</p></div>', esc_html__( 'Voucher Manager could not start because Composer dependencies are missing. Run "composer install" in the plugin directory.', 'voucher-manager' ) );
	} );
	return;
}
